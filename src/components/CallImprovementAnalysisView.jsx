...
function SummarySection({ summary }) {
  ...
  return <details className="group rounded-xl border border-blue-100 bg-blue-50 text-blue-900">
    <summary className="flex cursor-pointer list-none items-center gap-2 p-4 text-sm font-semibold"><span>Resumen</span><span className="ml-auto text-xs font-normal opacity-70 group-open:hidden">Ver</span><span className="ml-auto hidden text-xs font-normal opacity-70 group-open:inline">Ocultar</span></summary>
    <div className="border-t border-blue-900/10 px-4 pb-4 text-sm leading-relaxed">{textOf(summary)}</div>
  </details>;
}
